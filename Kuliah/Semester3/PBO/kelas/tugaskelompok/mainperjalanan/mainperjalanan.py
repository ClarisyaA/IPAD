        ...
        if pilihan == 1:
            while True:
                ...
                if pilihanInput == 1:
                    ...
                    print("Tanggal Berangkat : 1")
                    print("Bulan Berangkat\t : 1")
                    print("Tahun Berangkat\t : 2023")
                    print("Jam Berangkat\t : 10")
                    print("Menit Berangkat\t : 10")
                    print("Detik Berangkat : 10")
                    print()
                    print("Tanggal Kedatangan : 3")
                    print("Bulan Kedatangan : 1")
                    print("Tahun Kedatangan : 2023")
                    print("Jam Kedatangan : 9")
                    print("Menit Kedatangan : 10")
                    print("Detik Kedatangan : 10")
